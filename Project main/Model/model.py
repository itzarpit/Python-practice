...
class Functions:
    def __init__(self,data):
        self.client = MongoClient("mongodb+srv://arpit-mtalkz:12345@cluster0.cbks6s7.mongodb.net/Contact?retryWrites=true&w=majority")
        self.database = data['Contact']
        self.collection = data['Book']
